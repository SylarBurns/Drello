...
class Board_Manager:
    ...
    def board_create(self):
        ...
        for email in Members_Email:
            if email == "no":
                ...
                print("adding a new User to the board with email "+email)#search the User_ID with the email address and add them to the BoardMemeber table.
    ...
    def start(self):
        ...
        while(choice != 4):
            ...
            os.system('cls' if os.name == 'nt' else 'clear')
# mycursor = ""                
a =Board_Manager(55, mycursor, mydb)
a.start()
